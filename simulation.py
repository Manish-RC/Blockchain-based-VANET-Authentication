...
print("Verification block: Start of simulation")


class TrafficSignal:
    def __init__(self, red, yellow, green):
        print("Traffic signal initialized with R:", red, "Y:", yellow, "G:", green)


class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        print(
            "Vehicle created in lane",
            lane,
            "class:",
            vehicleClass,
            "direction:",
...
print("Starting vehicle generation thread...")
thread2 = threading.Thread(name="generateVehicles", args=())

print("Starting simulation time counter...")
thread3 = threading.Thread(name="simTime", args=())
...
def block_add():
    block_value = str(random.randint(0, 1000000))  # Generating a random value
    hash_object = hashlib.sha256(block_value.encode())  # Creating a hash object
    hash_value = (
...
print("Genesis Block initialize...")
